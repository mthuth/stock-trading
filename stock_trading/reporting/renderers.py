...
def render_top5_opportunities(context: dict[str, object]) -> str:
...
def top5_opportunities_markdown_lines(context: dict[str, object]) -> list[str]:
    section = queue(context, "top5_opportunities") or queue(context, "top_5_opportunities")
...
<body>
  ...
  <main>
    ...
    {render_top5_opportunities(context)}
...
def render_markdown(context: dict[str, object], kind: str = "daily") -> str:
    ...
    lines = [
        ...
        "",
        *top5_opportunities_markdown_lines(context),
