...
class PresentationBoundaryTests(unittest.TestCase):
    def test_render_report_context_from_fixture_writes_artifacts(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertLess(dashboard_text.index("Long-Term Capital Deployment Review"), dashboard_text.index("Earnings Review"))
            ...
            self.assertLess(dashboard_text.index("Alerts And Review Triggers"), dashboard_text.index("Learning Review"))
